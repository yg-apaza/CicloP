...
!function(e) {
	...
	var t = function(e) {
				this.messages = {
					...
					type : {
						email : "<p class='text-danger'>Datos incorrectos</p>",
						url : "This value should be a valid url.",
						urlstrict : "This value should be a valid url.",
						number : "Datos incorrectos",
						digits : "This value should be digits.",
						dateIso : "This value should be a valid date (YYYY-MM-DD).",
						alphanum : "<p class='text-danger'>Datos incorrectos</p>",
						palabras: "<p class='text-danger'>Datos incorrectos</p>",
						usuario: "<p class='text-danger'>Datos incorrectos</p>",
						phone : "Este valor debe ser un número de teléfono válido"
					},
					notnull : "This value should not be null.",
					notblank : "This value should not be blank.",
					required : "<p class='text-danger'>Campo obligatorio vacío</p>",
