...
&nbsp;
<span class="fstat-no" title="function not covered" >    function serveAngular(path) {</span>
<span class="cstat-no" title="statement not covered" >      router.get(path, <span class="fstat-no" title="function not covered" >function (req, res) {</span></span>
<span class="cstat-no" title="statement not covered" >        res.sendfile(web.angularPath + '/index.html');</span>
      });
    }
&nbsp;
...
&nbsp;
    if (web.register.enabled) {
      if (web.idSite.enabled) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (web.angularPath) {
<span class="cstat-no" title="statement not covered" >          serveAngular(web.register.uri);</span>
        } else {
...
&nbsp;
    if (web.login.enabled) {
      if (web.idSite.enabled) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (web.angularPath) {
<span class="cstat-no" title="statement not covered" >          serveAngular(web.login.uri);</span>
        } else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Nov 06 2015 11:48:24 GMT-0800 (PST)
</div>
</div>
